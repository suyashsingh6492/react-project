...
export function Opinion({ opinion: { id, title, body, userName, votes } }) {
  ...
  //It gives us a temporary value that's shown as long as the form is being submitted.
  //in the backend code we had an error it rollback to old value so 5->6->5
